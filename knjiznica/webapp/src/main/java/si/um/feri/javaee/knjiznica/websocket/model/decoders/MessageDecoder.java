package si.um.feri.javaee.knjiznica.websocket.model.decoders;
...
public class MessageDecoder implements Decoder.Text<Message> {
	...
	/*
	 * Decode a JSON message into a Map and check if it contains all the required
	 * fields according to its type.
	 */
	@Override
